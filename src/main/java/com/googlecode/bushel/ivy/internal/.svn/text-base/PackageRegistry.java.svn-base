...
import static com.googlecode.bushel.ivy.BushelManifestParser.PACKAGE;
...
import com.googlecode.bushel.ivy.BushelManifestParser;
import com.googlecode.bushel.util.Version;
import com.googlecode.bushel.util.VersionComparator;
...
public class PackageRegistry {
    ...
    private final BushelManifestParser osgiManifestParser = new BushelManifestParser();
