...
import com.googlecode.bushel.ivy.internal.PackageRegistry;
import com.googlecode.bushel.util.NameUtil;
import com.googlecode.bushel.util.NameUtil.OrgAndName;
 ...
 */
public class BushelManifestParser extends AbstractModuleDescriptorParser {
    ...
    private static final BushelManifestParser INSTANCE = new BushelManifestParser();

    public static BushelManifestParser getInstance() {
        return INSTANCE;
    }
    ...
    public static class InternalParser extends AbstractParser {
        ...
        public void parse(Resource res, boolean useExports) throws IOException {
            Manifest manifest;
            if (res.getName().toUpperCase().endsWith(".JAR")) {
